...
public class Book {
    ...
    /**
     * Compares the current book to a Book object, if o is a book object
     * 
     * @param Object o - an Object of any type
     * @return true if o is a Book and all attributes are the same, false otherwise
     */
    @Override
